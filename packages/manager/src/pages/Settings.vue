...
<style scoped>
.settings-nav { width:220px; display:flex; flex-direction:column; gap:0.5rem; position:sticky; top:86px; align-self:flex-start; padding:0.6rem; border-radius:8px; background:var(--bg-sec); box-shadow: 0 8px 20px rgba(0,0,0,0.25); border:1px solid var(--border-color); }
.settings-nav a { padding:0.6rem 0.8rem; border-radius:6px; color:var(--text-pri); background:transparent; text-decoration:none }
