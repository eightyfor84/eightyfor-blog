...
h2 { font-size: 1.15rem; color: var(--app-text-sec); margin: 32px 0 12px; border-bottom: 1px solid var(--border-color); padding-bottom: 6px; }
h3 { font-size: 0.9rem; color: var(--app-text-sec); margin: 16px 0 8px; }
...
.muted { color: var(--app-text-sec); font-size: 0.85rem; }
</style>
